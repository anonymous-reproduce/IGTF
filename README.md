...
- `intent_data/expert_intent_annotations_2000.jsonl`: 2,000 selected
  9-d intent annotation records, balanced across the four datasets.
...
splits with balanced label and dominant-intent distributions.
